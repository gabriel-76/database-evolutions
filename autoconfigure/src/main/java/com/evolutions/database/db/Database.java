...
public interface Database {
   ...
   */
  public default com.evolutions.database.play.db.Database asScala() {
    return new  com.evolutions.database.play.db.Database() {
      @Override
      public String name() {
      ...
      public <A> A withTransaction(
           com.evolutions.database.play.db.TransactionIsolationLevel isolationLevel,
