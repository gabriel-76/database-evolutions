...
public class DefaultDBApi implements DBApi {
  ...
  private com.evolutions.database.play.db.DBApi dbApi;
  private List<Database> databases;
  private Map<String, Database> databaseByName;

  public DefaultDBApi(com.evolutions.database.play.db.DBApi dbApi) {
    this.dbApi = dbApi;
    ...
    for ( com.evolutions.database.play.db.Database db : Scala.asJava(dbApi.databases())) {
