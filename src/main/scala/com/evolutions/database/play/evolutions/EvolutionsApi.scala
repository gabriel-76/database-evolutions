 ...
 */
@Service
class DefaultEvolutionsApi(@Autowired private val dbApi: MyDatabase) extends EvolutionsApi {

  private def databaseEvolutions(name: String, schema: String) = new DatabaseEvolutions(dbApi, schema)
